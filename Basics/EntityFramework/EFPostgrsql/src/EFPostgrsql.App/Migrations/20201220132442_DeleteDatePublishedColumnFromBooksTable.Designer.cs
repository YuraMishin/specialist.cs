...
namespace EFPostgrsql.App.Migrations
{
    ...
    [Migration("20201220132442_DeleteDatePublishedColumnFromBooksTable")]
    partial class DeleteDatePublishedColumnFromBooksTable
    {
            ...
            modelBuilder.Entity("EFPostgrsql.App.Models.Book", b =>
                {
                    ...
                    b.HasOne("EFPostgrsql.App.Models.Category", "Category")
                        .WithMany()
